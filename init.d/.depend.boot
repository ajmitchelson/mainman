TARGETS = mountkernfs.sh udev mountdevsubfs.sh bootlogd keyboard-setup lvm2 hostname.sh hwclockfirst.sh checkroot.sh hwclock.sh ifupdown-clean module-init-tools mtab.sh checkfs.sh ifupdown nfs-common mountall.sh mountall-bootclean.sh mountoverflowtmp networking urandom procps udev-mtab x11-common mountnfs.sh portmap mountnfs-bootclean.sh kbd console-setup bootmisc.sh stop-bootlogd-single
...
stop-bootlogd-single: mountall.sh mountoverflowtmp udev keyboard-setup console-setup networking ifupdown nfs-common mountnfs.sh mountnfs-bootclean.sh hwclock.sh checkroot.sh ifupdown-clean portmap lvm2 mountdevsubfs.sh checkfs.sh urandom mountkernfs.sh hostname.sh hwclockfirst.sh kbd mountall-bootclean.sh procps module-init-tools mtab.sh bootlogd bootmisc.sh udev-mtab x11-common
